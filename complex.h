...
void
compute (float *d, float a, float b, float c, COMPLEX * r1, COMPLEX * r2)
{
  *d = ((b * b) - (4 * a * c));
  if (*d == 0)
    {
...
void
output (float *d, float a, float b, float c, COMPLEX  r1, COMPLEX  r2)
{
  if (*d == 0)
    {
  ...
  else
    {
      ...
      printf ("%f + (%f)i and %f - (%f)i", r1.real, r1.imag, r2.real,
	      r2.imag);
    }
}
